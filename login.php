...
<body style="  background-image: url(images/login1.jpg);  background-size: cover; background-position: center; background:linear-gradient(rgba(0,0,0, 0.4) rgba(0,0,0, 0.4)); ">
    ...
    ?>
<h2 style="text-align: center; padding: 2%; margin: 2%; margin-block: auto;">wellcom to my shop</h2>
